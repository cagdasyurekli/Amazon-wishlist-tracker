...
- [x] Change `manifest.json`, `package.json`, and `package-lock.json` from `1.4.3` to `1.4.4` together.
- [x] Move the relevant `CHANGELOG.md` entries from **Unreleased** to a dated `1.4.4` section.
